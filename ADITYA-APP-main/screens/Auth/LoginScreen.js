...
// If you moved auth persistence logic into a separate file
import { setAuthState } from '../../services/authUtils';
import { ActivityIndicator } from 'react-native';
import { clearAuthState } from '../../services/authUtils';
...
const handleLogin = async () => {
  ...
  try {
    ...
    const completeUser = {
      ...
      ...userData,
      lastLogin: new Date().toISOString() // Track last login time
    };
    ...
    // Update Firestore with last login time (optional)
